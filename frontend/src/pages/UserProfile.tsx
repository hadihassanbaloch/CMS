...
import { User, Edit3, Mail, Shield, Save, X } from 'lucide-react';
                  ...
                  {!isEditing ? (
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        disabled={saving}
                        className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-gray-600 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors disabled:opacity-50"
                      >
                        <X className="h-4 w-4" />
                        Cancel
                      </button>
                      <button
                        onClick={handleSave}
                        disabled={saving}
                        className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-white bg-teal-600 rounded-lg hover:bg-teal-700 transition-colors disabled:opacity-50"
                      >
              ...
              <div className="px-6 py-6 space-y-6">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    {user.is_admin && (
                      <span className="inline-flex items-center gap-1 px-2 py-1 mt-2 bg-amber-100 text-amber-800 text-xs font-medium rounded-full">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3 px-3 py-2 bg-gray-50 rounded-lg">
                      ...
                      <span className="text-gray-900">
                        {user.is_admin ? 'Administrator' : 'Patient'}
                      </span>
                    </div>
                  </div>
